...
class MilestonesControllerTest < ActionController::TestCase
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post :create, milestone: { date: @milestone.date, major_release: @milestone.major_release, name: @milestone.name }
    end
  ...
  test "should update milestone" do
    patch :update, id: @milestone, milestone: { date: @milestone.date, major_release: @milestone.major_release, name: @milestone.name }
    assert_redirected_to milestone_path(assigns(:milestone))
  end
